...
namespace CapnProto.Schema
{
    ...
    public partial class Field : global::CapnProto.IBlittable
    {
        ...
        public ushort discriminantValue
        {
            get
            {
                return unchecked((ushort)((this.ѧ_w_0 >> 16) ^ 65535));
            }
            set
            {
                this.ѧ_w_0 = (this.ѧ_w_0 & 0xffffffff0000ffff) | unchecked((((ulong)(value) ^ 65535) << 16));
            }
        }
