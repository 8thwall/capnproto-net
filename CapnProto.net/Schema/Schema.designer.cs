...
//            if (raw[0] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:CodeGeneratorRequest.nodes
//                this.ѧ_p_0 = ctx.Reader.ReadStructList<global::CapnProto.Schema.Node>(ctx, segment, origin + 1, raw[0]);
//            }
//            if (raw[1] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:CodeGeneratorRequest.requestedFiles
...
//                if (raw[0] != 0)
//                {
//                    // /home/marc/LogFormat/schema.capnp:CodeGeneratorRequest.RequestedFile.filename
//                    this.ѧ_p_0 = ctx.Reader.ReadStringFromPointer(segment, origin + 1, raw[0]);
//                }
//                if (raw[1] != 0)
//                {
//                    // /home/marc/LogFormat/schema.capnp:CodeGeneratorRequest.RequestedFile.imports
...
//                    if (raw[0] != 0)
//                    {
//                        // /home/marc/LogFormat/schema.capnp:CodeGeneratorRequest.RequestedFile.Import.name
//                        this.ѧ_p_0 = ctx.Reader.ReadStringFromPointer(segment, origin + 1, raw[0]);
//                    }
//                }
//                static Import()
...
//            if (raw[0] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:Method.name
//                this.ѧ_p_0 = ctx.Reader.ReadStringFromPointer(segment, origin + 1, raw[0]);
//            }
//            if (raw[1] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:Method.annotations
...
//            if (raw[0] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:Enumerant.name
//                this.ѧ_p_0 = ctx.Reader.ReadStringFromPointer(segment, origin + 1, raw[0]);
//            }
//            if (raw[1] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:Enumerant.annotations
//                this.ѧ_p_1 = ctx.Reader.ReadStructList<global::CapnProto.Schema.Annotation>(ctx, segment, origin + 2, raw[1]);
//            }
//        }
//        static Enumerant()
...
//                // /home/marc/LogFormat/schema.capnp:Node.enum.enumerants
...
//                // /home/marc/LogFormat/schema.capnp:Node.interface.methods
...
//                // /home/marc/LogFormat/schema.capnp:Node.const.type
...
//                // /home/marc/LogFormat/schema.capnp:Node.annotation.type
...
//            if (raw[4] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:Node.interface.extends
//                if ((this.ѧ_w_1 & 0xffff00000000) == 0x300000000) this.ѧ_p_4 = null;
//#warning not yet supported: uint64
//                // /home/marc/LogFormat/schema.capnp:Node.const.value
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(6, 0, 0)]
...
//                {
//                    if (!((this.parent.ѧ_w_1 & 0xffff00000000) == 0x100000000)) throw new global::CapnProto.InvalidUnionDiscriminatorException();
//                    throw new global::System.NotImplementedException(); // enum
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x100000000)
//                    {
//                        return (this.parent.ѧ_w_3 & 0x100000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_3 |= 0x100000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_3 &= 0xfffffffeffffffff;
//                    }
//                }
//            }
...
//            public global::System.Collections.Generic.List<ulong> extends
//            {
//                get
//                {
//                    return (this.parent.ѧ_w_1 & 0xffff00000000) == 0x300000000 ? (global::System.Collections.Generic.List<ulong>)this.parent.ѧ_p_4 : null;
//                }
//                set
//                {
//                    if (!((this.parent.ѧ_w_1 & 0xffff00000000) == 0x300000000)) throw new global::CapnProto.InvalidUnionDiscriminatorException();
...
//                    {
//                        return (this.parent.ѧ_w_1 & 0x1000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x1000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xfffeffffffffffff;
//                    }
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x500000000)
//                    {
//                        return (this.parent.ѧ_w_1 & 0x2000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x2000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xfffdffffffffffff;
//                    }
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x500000000)
//                    {
//                        return (this.parent.ѧ_w_1 & 0x4000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x4000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xfffbffffffffffff;
//                    }
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x500000000)
//                    {
//                        return (this.parent.ѧ_w_1 & 0x8000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x8000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xfff7ffffffffffff;
//                    }
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x500000000)
//                    {
//                        return (this.parent.ѧ_w_1 & 0x10000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x10000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xffefffffffffffff;
//                    }
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x500000000)
//                    {
//                        return (this.parent.ѧ_w_1 & 0x20000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x20000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xffdfffffffffffff;
//                    }
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x500000000)
//                    {
//                        return (this.parent.ѧ_w_1 & 0x40000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x40000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xffbfffffffffffff;
//                    }
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x500000000)
//                    {
//                        return (this.parent.ѧ_w_1 & 0x80000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x80000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xff7fffffffffffff;
//                    }
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x500000000)
//                    {
//                        return (this.parent.ѧ_w_1 & 0x100000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x100000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xfeffffffffffffff;
//                    }
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x500000000)
//                    {
//                        return (this.parent.ѧ_w_1 & 0x200000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x200000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xfdffffffffffffff;
//                    }
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x500000000)
//                    {
//                        return (this.parent.ѧ_w_1 & 0x400000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x400000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xfbffffffffffffff;
//                    }
//                }
//            }
...
//                    if ((this.parent.ѧ_w_1 & 0xffff00000000) == 0x500000000)
//                    {
//                        return (this.parent.ѧ_w_1 & 0x800000000000000) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_1 |= 0x800000000000000;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_1 &= 0xf7ffffffffffffff;
//                    }
//                }
//            }
//        }
...
//                if (raw[0] != 0)
//                {
//                    // /home/marc/LogFormat/schema.capnp:Node.NestedNode.name
//                    this.ѧ_p_0 = ctx.Reader.ReadStringFromPointer(segment, origin + 1, raw[0]);
//                }
//            }
//            static NestedNode()
...
//            global::CapnProto.TypeModel.AssertLittleEndian();
//        }
//        [global::CapnProto.FieldAttribute(0, 0, 0)]
...
//                {
//                    return unchecked((byte)((this.ѧ_w_0 >> 16)));
//                }
//                return null;
//            }
//            set
...
//                throw new global::System.NotImplementedException(); // float32
//            }
//        }
...
//                throw new global::System.NotImplementedException(); // float64
//            }
//        }
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(17, 0, 0)]
...
//            if (raw[0] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:Type.list.elementType
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(1, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(2, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(3, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(4, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(5, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(7, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(8, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(9, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(10, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(11, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(12, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(13, 0, 0)]
...
//            }
//        }
//        [global::CapnProto.FieldAttribute(18, 0, 0)]
...
//            if (raw[0] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:Field.name
//                this.ѧ_p_0 = ctx.Reader.ReadStringFromPointer(segment, origin + 1, raw[0]);
//            }
//            if (raw[1] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:Field.annotations
//                this.ѧ_p_1 = ctx.Reader.ReadStructList<global::CapnProto.Schema.Annotation>(ctx, segment, origin + 2, raw[1]);
//            }
//            if (raw[2] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:Field.slot.type
...
//            if (raw[3] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:Field.slot.defaultValue
...
//                    if ((this.parent.ѧ_w_1 & 0xffff) == 0x0)
//                    {
//                        return (this.parent.ѧ_w_2 & 0x1) != 0;
//                    }
//                    return null;
//                }
//                set
...
//                    if (value.Value)
//                    {
//                        this.parent.ѧ_w_2 |= 0x1;
//                    }
//                    else
//                    {
//                        this.parent.ѧ_w_2 &= 0xfffffffffffffffe;
//                    }
//                }
//            }
//        }
...
//            get
//            {
//                return new global::CapnProto.Schema.Field.ordinalGroup(this);
//            }
//        }
...
//        {
//            private readonly global::CapnProto.Schema.Field parent;
//            internal ordinalGroup(global::CapnProto.Schema.Field parent)
//            {
//                this.parent = parent;
//            }
//            [global::CapnProto.FieldAttribute(8, 0, 0)]
//            public global::CapnProto.Void @implicit
//            {
//                get
//                {
//                    return (this.parent.ѧ_w_1 & 0xffff0000) == 0x0 ? global::CapnProto.Void.Value : null;
//                }
//            }
...
//                get
//                {
//                    if ((this.parent.ѧ_w_1 & 0xffff0000) == 0x10000)
//                    {
//                        return unchecked((ushort)((this.parent.ѧ_w_1 >> 32)));
//                    }
//                    return null;
//                }
//                set
//                {
//                    if (!((this.parent.ѧ_w_1 & 0xffff0000) == 0x10000)) throw new global::CapnProto.InvalidUnionDiscriminatorException();
//                    this.parent.ѧ_w_1 = (this.parent.ѧ_w_1 & 0xffff0000ffffffff) | unchecked(((ulong)(value.Value) << 32));
//                }
//            }
//            public enum Unions
//            {
...
//                get
//                {
//                    return (global::CapnProto.Schema.Field.ordinalGroup.Unions)((this.parent.ѧ_w_1 >> 16) & 0xFFFF);
//                }
//                set
//                {
//                    this.parent.ѧ_w_1 = (this.parent.ѧ_w_1 & 0xffffffff0000ffff) | ((ulong)value << 16);
//                }
//            }
//        }
//        public enum Unions
...
//            if (raw[0] != 0)
//            {
//                // /home/marc/LogFormat/schema.capnp:Annotation.value
//                this.ѧ_p_0 = global::CapnProto.Schema.SchemaSerializer.ѧ_SerializerBase.ѧ_r_ce23dcd2d7b00c9b(segment, origin + 1, ctx, raw[0]);
//            }
//        }
//        static Annotation()
//        {
...
//            get
//            {
//                return (global::CapnProto.Schema.Value)this.ѧ_p_0;
//            }
//            set
//            {
//                this.ѧ_p_0 = value;
...
//    {
//        private global::CapnProto.ITypeSerializer ѧ_f_ae504193122357e5, ѧ_f_bfc546f6210ad7ce, ѧ_f_cfea0eb02e810062, ѧ_f_9500cce23b334d80, ѧ_f_978a7cebdc549a4d, ѧ_f_e682ab4cf923a417, ѧ_f_ce23dcd2d7b00c9b, ѧ_f_d07378ede1f9cc60, ѧ_f_9aad50a41f4af45f, ѧ_f_debf55bbfa0fc242, ѧ_f_f1c8950dab257542;
